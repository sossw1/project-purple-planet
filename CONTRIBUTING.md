...
1. Fork the project (```https://github.com/davidsaulrodriguez/project-purple-planet```)
2. Clone it on your machine (```git clone https://github.com/yourUsername/project-purple-planet.git```)
3. Add the upstream remote (```git remote add upstream https://github.com/davidsaulrodriguez/project-purple-planet.git```)
